...
def programar_todo_en_thread():
    ...
    # Solo si los datos están completos, desactivamos botones y actualizamos UI
...
def mostrar_ayuda():
    ...
    # Desactivar el botón de ayuda para evitar múltiples ventanas
    ...
    try:
        ...
        label_logo.image = logo_tk  # evitar garbage collection
        ...
        label_logo2.image = logo2_tk  # evitar garbage collection
