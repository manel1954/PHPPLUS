...
/* ✅ BANDERAS PREMIUM CON MOVIMIENTO */
@-webkit-keyframes flagFloat {
...
@-webkit-keyframes flagGlow {
  0%, 100% { box-shadow: 0 4px 8px rgba(0,0,0,.4), inset 0 1px 0 rgba(255,255,255,0.1), 0 0 0 rgba(255,255,255,0); }
  50% { box-shadow: 0 4px 12px rgba(0,0,0,.4), inset 0 1px 0 rgba(255,255,255,0.2), 0 0 12px rgba(255,255,255,0.15); }
}
@keyframes flagGlow {
  0%, 100% { box-shadow: 0 4px 8px rgba(0,0,0,.4), inset 0 1px 0 rgba(255,255,255,0.1), 0 0 0 rgba(255,255,255,0); }
  50% { box-shadow: 0 4px 12px rgba(0,0,0,.4), inset 0 1px 0 rgba(255,255,255,0.2), 0 0 12px rgba(255,255,255,0.15); }
...
.flag-wrap {
    ...
    box-shadow: 0 4px 8px rgba(0,0,0,.4), inset 0 1px 0 rgba(255,255,255,0.1);
    transition: transform 0.3s ease; vertical-align: middle; margin-right: 6px; background: #000;
    -webkit-animation: flagFloat 3s ease-in-out infinite, flagGlow 4s ease-in-out infinite;
    animation: flagFloat 3s ease-in-out infinite, flagGlow 4s ease-in-out infinite;
}
.flag-wrap:hover { 
    -webkit-animation: none; animation: none;
    transform: scale(1.25) rotate(0deg); border-color: rgba(255,255,255,0.6);
    box-shadow: 0 0 20px rgba(255,255,255,0.25);
}
.flag-wrap svg { width: 100%; height: 100%; object-fit: cover; }
...
@media (max-width: 600px) {
  ...
  .flag-wrap { width: 28px; height: 28px; margin-right: 4px; }
}

/* ✅ TIEMPO TX (CRONÓMETRO) */
...
<script>
// ✅ BANDERAS PREMIUM (SVG INLINE)
const FLAGS = {
  ES: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 500" width="100%" height="100%"><rect width="750" height="500" fill="#c60b1e"/><rect y="125" width="750" height="250" fill="#ffc400"/></svg>',
  PT: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 660 400" width="100%" height="100%"><rect width="660" height="400" fill="#006600"/><rect x="330" width="330" height="400" fill="#ff0000"/><circle cx="330" cy="200" r="70" fill="#ffcd00"/><circle cx="330" cy="200" r="52" fill="#006600"/></svg>',
  FR: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="100%" height="100%"><rect width="900" height="600" fill="#fff"/><rect width="300" height="600" fill="#002395"/><rect x="600" width="300" height="600" fill="#ed2939"/></svg>',
  IT: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1500 1000" width="100%" height="100%"><rect width="500" height="1000" fill="#009246"/><rect x="500" width="500" height="1000" fill="#fff"/><rect x="1000" width="500" height="1000" fill="#ce2b37"/></svg>',
  GB: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 30" width="100%" height="100%"><rect width="60" height="30" fill="#00247d"/><path d="M0 0L60 30M60 0L0 30" stroke="#fff" stroke-width="3.5"/><path d="M0 0L60 30M60 0L0 30" stroke="#cf142b" stroke-width="1.8"/><path d="M30 0v30M0 15h60" stroke="#fff" stroke-width="5"/><path d="M30 0v30M0 15h60" stroke="#cf142b" stroke-width="2.5"/></svg>',
  DE: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 600" width="100%" height="100%"><rect width="1000" height="600"/><rect y="200" width="1000" height="200" fill="#dd0000"/><rect y="400" width="1000" height="200" fill="#ffce00"/></svg>',
  US: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1235 650" width="100%" height="100%"><rect width="1235" height="650" fill="#b22234"/><rect width="1235" height="50" fill="#fff" y="50"/><rect width="1235" height="50" fill="#fff" y="150"/><rect width="1235" height="50" fill="#fff" y="250"/><rect width="1235" height="50" fill="#fff" y="350"/><rect width="1235" height="50" fill="#fff" y="450"/><rect width="1235" height="50" fill="#fff" y="550"/><rect width="494" height="350" fill="#3c3b6e"/></svg>',
  CA: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 250" width="100%" height="100%"><rect width="500" height="250" fill="#fff"/><rect width="125" height="250" fill="#ff0000"/><rect x="375" width="125" height="250" fill="#ff0000"/></svg>',
  BR: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1100 700" width="100%" height="100%"><rect width="1100" height="700" fill="#009739"/><path d="M550 80L1020 350L550 620L80 350Z" fill="#fedd00"/><circle cx="550" cy="350" r="140" fill="#002776"/></svg>',
  AR: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="100%" height="100%"><rect width="900" height="600" fill="#fff"/><rect width="900" height="200" fill="#75aadb"/><rect y="400" width="900" height="200" fill="#75aadb"/></svg>',
  JP: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="100%" height="100%"><rect width="900" height="600" fill="#fff"/><circle cx="450" cy="300" r="160" fill="#bc002d"/></svg>',
  AU: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 600" width="100%" height="100%"><rect width="1200" height="600" fill="#00008b"/><rect width="600" height="300" fill="#fff"/><path d="M0 0L600 300M600 0L0 300" stroke="#e4002b" stroke-width="4"/><path d="M300 0v300M0 150h600" stroke="#e4002b" stroke-width="6"/></svg>',
  ZA: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="100%" height="100%"><rect width="900" height="600" fill="#007749"/><path d="M0 0L300 300L0 600Z" fill="#000"/><path d="M0 0L300 300L0 600Z" stroke="#ffb81c" stroke-width="25" fill="none"/><path d="M300 300H900" stroke="#fff" stroke-width="60"/><path d="M300 300H900" stroke="#000" stroke-width="30"/></svg>',
  FI: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1800 1100" width="100%" height="100%"><rect width="1800" height="1100" fill="#fff"/><rect y="400" width="1800" height="300" fill="#003580"/><rect x="500" width="300" height="1100" fill="#003580"/></svg>',
  NL: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="100%" height="100%"><rect width="900" height="600" fill="#ae1c28"/><rect y="200" width="900" height="200" fill="#fff"/><rect y="400" width="900" height="200" fill="#21468b"/></svg>',
  CH: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 480" width="100%" height="100%"><rect width="480" height="480" fill="#ff0000"/><rect x="200" y="120" width="80" height="240" fill="#fff"/><rect x="120" y="200" width="240" height="80" fill="#fff"/></svg>',
  AT: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="100%" height="100%"><rect width="900" height="600" fill="#ed2939"/><rect y="200" width="900" height="200" fill="#fff"/><rect y="400" width="900" height="200" fill="#ed2939"/></svg>',
  PL: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 800" width="100%" height="100%"><rect width="1280" height="800" fill="#dc143c"/><rect width="1280" height="400" fill="#fff"/></svg>',
  RU: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="100%" height="100%"><rect width="900" height="600" fill="#fff"/><rect y="200" width="900" height="200" fill="#0039a6"/><rect y="400" width="900" height="200" fill="#d52b1e"/></svg>',
  GR: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 18" width="100%" height="100%"><rect width="27" height="18" fill="#0d5eaf"/><path d="M9 0v9h9M0 9h27M0 13.5h27M0 4.5h27" stroke="#fff" stroke-width="2"/></svg>',
  LT: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 400" width="100%" height="100%"><rect width="600" height="400" fill="#fdb913"/><rect y="133" width="600" height="134" fill="#006a44"/><rect y="267" width="600" height="133" fill="#c1272d"/></svg>',
  HR: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 600" width="100%" height="100%"><rect width="1200" height="600" fill="#ff0000"/><rect y="200" width="1200" height="200" fill="#fff"/><rect y="400" width="1200" height="200" fill="#171796"/></svg>'
};

function getFlagByCall(callsign) {
    if (!callsign) return '<span class="flag-wrap">'+FLAGS.ES+'</span>';
    ...
    for(const p of prefixes){ if(p.re.test(cs)) return '<span class="flag-wrap">'+FLAGS[p.code]+'</span>'; }
    return '<span class="flag-wrap">'+FLAGS.ES+'</span>';
}

// ✅ TEMPORIZADOR TX (CRONÓMETRO) - CORREGIDO
const txTimers = { dmr: {}, ysf: {}, dstar: {}, nxdn: {} };
function startTxTimer(mode) {
  const t = txTimers[mode];
  t.el = document.getElementById(mode+'TxTimer');
  if(!t.el) return;
  // Solo iniciar si no hay un timer activo
  if (!t.start) {
    t.start = Date.now();
    ...
    t.interval = setInterval(() => {
      ...
      if(t.el) t.el.textContent = mm+':'+ss;
    }, 1000);
  }
  // Siempre asegurar que es visible
...
function showActive(d){
  ...
  // ✅ Siempre iniciar/actualizar timer y barra TX
  startTxTimer('dmr');
...
function showYSFIdle(){ysfCurrentlyActive=false;animateVU(false,'ysf');stopTxTimer('ysf');document.getElementById('ysfTxBar').className='nx-txbar';document.getElementById('ysfDest').textContent='—';document.getElementById('ysfProto').textContent='YSF';const src=document.getElementById('ysfSource');src.textContent='';src.className='nx-source';document.getElementById('ysfNxCenter').innerHTML='<div class="nx-clock" id="ysfNxClock" style="color:#c084ff;">00:00:00</div><div class="nx-date" id="ysfNxDate" style="color:#9b59d4;">—</div><span id="ysfTxTimer" class="nx-tx-timer ysf-tx-timer">00:00</span>';updateClock();}
...
function showDStarIdle(){dstarCurrentlyActive=false;animateDStarVU(false);stopTxTimer('dstar');document.getElementById('dstarTxBar').className='nx-txbar';const src=document.getElementById('dstarSource');src.textContent='';src.className='nx-source';document.getElementById('dstarNxCenter').innerHTML='<div class="nx-clock" id="dstarNxClock" style="color:#00e5ff;">00:00:00</div><div class="nx-date" id="dstarNxDate" style="color:#009090;">—</div><span id="dstarTxTimer" class="nx-tx-timer dstar-tx-timer">00:00</span>';updateDStarClock();}
function showDStarActive(d){
  if(!dstarCurrentlyActive){
    dstarCurrentlyActive=true;
    animateDStarVU(true);
    const flag=getFlagByCall(d.callsign.replace(/\/.*$/,''));
  ...
  startTxTimer('dstar');
  document.getElementById('dstarTxBar').className='nx-txbar';
  document.getElementById('dstarTxBar').style.background='linear-gradient(90deg,transparent,#00e5ff,transparent)';
  document.getElementById('dstarTxBar').style.backgroundSize='200% 100%';
  document.getElementById('dstarTxBar').style.animation='scan 1.4s linear infinite';
  const src=document.getElementById('dstarSource');
  if(d.source==='RF'){src.textContent='RF';src.className='nx-source rf';}
  else{src.textContent='NET';src.className='nx-source net';}
}
...
function showNXDNIdle(){nxdnCurrentlyActive=false;animateNXDNVU(false);stopTxTimer('nxdn');document.getElementById('nxdnTxBar').className='nx-txbar';document.getElementById('nxdnTGLabel').textContent='—';const src=document.getElementById('nxdnSource');src.textContent='';src.className='nx-source';document.getElementById('nxdnNxCenter').innerHTML='<div class="nx-clock" id="nxdnNxClock" style="color:#ffd700;">00:00:00</div><div class="nx-date" id="nxdnNxDate" style="color:#b8a000;">—</div><span id="nxdnTxTimer" class="nx-tx-timer nxdn-tx-timer">00:00</span>';updateNXDNClock();}
function showNXDNActive(d){
  if(!nxdnCurrentlyActive){
    nxdnCurrentlyActive=true;
    animateNXDNVU(true);
    const flag=getFlagByCall(d.callsign);
  ...
  startTxTimer('nxdn');
  document.getElementById('nxdnTxBar').className='nx-txbar active-nxdn';
  document.getElementById('nxdnTGLabel').textContent=d.tg?'TG '+d.tg:'—';
  const src=document.getElementById('nxdnSource');
  if(d.source==='RF'){src.textContent='RF';src.className='nx-source rf';}
  else{src.textContent='NET';src.className='nx-source net';}
}
