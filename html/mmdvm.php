...
<div class="station-card" style="justify-content:space-between;">
    ...
    <div class="station-meta-item" style="flex:1;align-items:flex-start;"><span class="station-meta-label" style="font-size:.55rem;">💿 Disco libre</span><span class="station-meta-value" id="siDiskFree" style="color:var(--green);font-size:.75rem;min-width:4.5rem;white-space:nowrap;">—</span></div>
