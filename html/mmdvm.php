...
<div class="display-row" style="margin-top:1.2rem;">
  <div id="dstarDisplayPanel">
    ...
    <div class="nextion-dstar">
      ...
      <div class="nx-botbar dstar-bar"><span style="color:#006070;font-family:var(--font-mono);font-size:.65rem;">D-STAR · DIGITAL VOICE</span><span style="color:#ff0;font-family:var(--font-mono);font-size:.80rem;"><?php $dgwIni=parseMMDVMIni('/home/pi/DStarGateway/DStarGateway.ini');$dstarRef=trim($dgwIni['Repeater1']['Reflector']??'—');echo "Reflector: ".htmlspecialchars($dstarRef); ?></span><span class="nx-source" id="dstarSource"></span></div>
    </div>
  </div>
