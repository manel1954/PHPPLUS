...
.nx-callsign { font-family: var(--font-orb); font-size: 40px; font-weight: 900; letter-spacing: .04em; line-height: 1; color: var(--green); text-shadow: 0 0 20px rgba(255,255,159,.55); }
