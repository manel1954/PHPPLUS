...
.status-bar { display: flex; gap: .8rem; margin-bottom: 1.8rem; flex-wrap: nowrap; align-items: center; background: linear-gradient(135deg,var(--surface) 0%,#0d1e2a 100%); border: 1px solid var(--border); border-radius: 10px; padding: .8rem 1.2rem; box-shadow: 0 4px 15px rgba(0,0,0,0.2); overflow-x: auto; }
